  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans selection:bg-stone-200 selection:text-stone-900 relative bg-noise">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20ba5a] text-white p-3 rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.15)] hover:shadow-[0_6px_16px_rgba(0,0,0,0.2)] transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2 group pulse-soft"
      ...
      >
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <div className="flex flex-col cursor-pointer group" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <span className="text-sm md:text-2xl font-serif-display tracking-wider md:tracking-widest font-semibold text-stone-900 group-hover:text-stone-600 transition-colors leading-tight">
              DRA. NATHÁLIA LIMA SOUZA
            </span>
            <span className="text-[9px] md:text-[10px] uppercase tracking-[0.15em] md:tracking-[0.2em] text-stone-500 font-body font-medium mt-0.5">
              CRM-PI 12072
            </span>
          </div>
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 text-center md:text-left order-2 md:order-1">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start items-center">
              <button
                onClick={() => setIsSchedulingOpen(true)}
                className="bg-stone-900 text-white px-10 py-4 hover:bg-stone-800 transition-all duration-300 font-body text-xs tracking-[0.2em] uppercase shadow-lg shadow-stone-900/20 btn-glow"
              >
                Agendar Consulta
              </button>
              <button
          ...
          <div className="w-full md:w-1/2 h-[50vh] md:h-[90vh] relative order-1 md:order-2">
            <div
              className="absolute inset-0 bg-stone-200 rounded-bl-[5rem] rounded-tr-[5rem] overflow-hidden shadow-2xl"
